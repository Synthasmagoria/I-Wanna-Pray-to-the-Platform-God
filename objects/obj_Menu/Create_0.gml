...
unsoftlocker_access = 9;
unsoftlocker_button = vk_enter;
...
option[menu_sub_settings,1] = "Framerate:";
option[menu_sub_settings,2] = "Music";
option[menu_sub_settings,3] = "Sound";
option[menu_sub_settings,4] = "Set defaults";
...
save_value_name[2] = "ENDING: ";
save_value_name[3] = "BRAGGING RIGHTS: ";

// Settings string array
setting = array_create(option_number[menu_sub_settings], "");
setting[0] = window_get_fullscreen() ? "true" : "false";
...
button[0] = scr_ButtonString(global.button[BUTTON.RIGHT]);
button[1] = scr_ButtonString(global.button[BUTTON.UP]);
button[2] = scr_ButtonString(global.button[BUTTON.LEFT]);
button[3] = scr_ButtonString(global.button[BUTTON.DOWN]);
button[4] = scr_ButtonString(global.button[BUTTON.JUMP]);
button[5] = scr_ButtonString(global.button[BUTTON.SHOOT]);
button[6] = scr_ButtonString(global.button[BUTTON.RETRY]);
button[7] = scr_ButtonString(global.button[BUTTON.PAUSE]);
button[8] = scr_ButtonString(global.button[BUTTON.SUICIDE]);
